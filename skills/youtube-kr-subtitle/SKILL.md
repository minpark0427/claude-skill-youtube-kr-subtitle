...
description: Download YouTube videos, extract English subtitles, translate them to Korean using Claude's translation capabilities (with video context and web search), and burn Korean subtitles into the video. Use this skill when the user requests Korean subtitle insertion for YouTube videos or asks to translate YouTube content to Korean.
---

# YouTube Korean Subtitle Auto-Insertion

This skill enables automated processing of YouTube videos: downloading, extracting English subtitles, translating to Korean with full context awareness, and burning Korean subtitles directly into the video file.
